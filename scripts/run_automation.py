...
def main() -> None:
    ...
    music_config = args.music_config or project_root / "configs" / "examples" / "music.yaml"
    upload_config = args.upload_config or project_root / "configs" / "examples" / "upload.yaml"
